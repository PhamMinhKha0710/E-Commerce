          ...
          <div className="row d-flex align-items-center">
                ...
                >
                  ...
                  <div className="search-suggest">
                    ...
                    <div className="list-search-suggest">
                      <div className="list-search list-search-style active" id="tab-search-1"></div>
            ...
            <div className="col-xl-3 col-lg-3 col-md-12 col-12 d-flex align-items-center col-right">
              ...
              <div className="header-wish">
                <a href="yeu-thich.html" title="Yêu thích">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={25}
                    height={21}
              ...
              <span className="info">Tài khoản</span>
                {isLoggedIn ? (
                  <div className="user-profile">
                    ...
                    <span className="info">{user?.name || 'Tài khoản'}</span>
              ...
              <div className="header-cart">
                <Link className="cart-head" href="/cart" title="Giỏ hàng">
        ...
        <div className="container">
          <div className="header-menu-scroll">
            <nav className="header-nav">
              <ul className="item_big item_big_index">
